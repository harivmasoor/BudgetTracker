    ...
    <div className="contact-us-page">
     ...
     <div className='elilta'>
        ...
        <div className="icons-container">
          <a  href="https://github.com/eliltaA" ><i class="fa-brands fa-github"></i></a>
          <a  href="eliltatabrham@gmail.com" ><i class="fa fa-user-circle"></i></a>
          <a  href="https://www.linkedin.com/in/elilta-abrham-87b79228b/" ><i class="fa-brands fa-linkedin"></i></a>
      ...
      <div className='dominic'>
        ...
        <div className="icons-container">
          <a  href="https://github.com/dominicchanDmc" ><i class="fa-brands fa-github"></i></a>
          <a  href="https://dominicchan.netlify.app/" ><i class="fa fa-user-circle"></i></a>
          <a  href="https://www.linkedin.com/in/dominic-chan-0b4128255" ><i class="fa-brands fa-linkedin"></i></a>
          <div className="about-me">
...
I'm currently looking for a job where I can make an impact, and using my debugging experience to solve problems.
      ...
      <div className='hari'>
        ...
        <div className="icons-container">
          <a  href="https://github.com/harivmasoor" ><i class="fa-brands fa-github"></i></a>
          <a  href="https://harimasoor.com" ><i class="fa fa-user-circle"></i></a>
          <a  href="https://www.linkedin.com/in/harimasoor/" ><i class="fa-brands fa-linkedin"></i></a> 
          <div className="about-me">
